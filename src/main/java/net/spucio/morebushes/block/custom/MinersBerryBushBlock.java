...
public class MinersBerryBushBlock extends SweetBerryBushBlock {
    ...
    protected boolean mayPlaceOn(BlockState pState, BlockGetter pLevel, BlockPos pPos) {
        return pState.is(Blocks.STONE) || pState.is(Blocks.DEEPSLATE) || pState.is(Blocks.COBBLESTONE) || pState.is(Blocks.MOSSY_COBBLESTONE) || pState.is(Blocks.GRANITE) || pState.is(Blocks.ANDESITE) || pState.is(Blocks.TUFF)|| pState.is(Blocks.DIORITE);
    }

    @Override
    public boolean canSurvive(BlockState state, LevelReader worldIn, BlockPos pos) {
        BlockState soil = worldIn.getBlockState(pos.below());
        return soil.is(Blocks.STONE) || soil.is(Blocks.DEEPSLATE) || soil.is(Blocks.COBBLESTONE) || soil.is(Blocks.GRANITE) || soil.is(Blocks.ANDESITE) || soil.is(Blocks.TUFF)|| soil.is(Blocks.DIORITE); // dodaj tu swoje bloki
    }
}