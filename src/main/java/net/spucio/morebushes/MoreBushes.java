...
public class MoreBushes
{
    ...
    public MoreBushes(FMLJavaModLoadingContext context)
    {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        if (event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS) {
            ...
            event.accept(ModItems.LAVABERRIES);
            event.accept(ModItems.GOLDENBERRIES);
            event.accept(ModItems.GLOWSTONEBERRIES);
            event.accept(ModItems.MINERSBERRIES);
            event.accept(ModItems.SHULKERBERRIES);
            event.accept(ModItems.CHORUSBERRIES);
        }
    }
