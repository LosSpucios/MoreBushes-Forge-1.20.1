...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MORE_BUSHES_TAB = CREATIVE_MODE_TABS.register("more_bushes_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BLUEBERRIES.get()))
                    .title(Component.translatable("More Bushes"))
